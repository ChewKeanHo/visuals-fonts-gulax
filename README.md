# Gulax Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Gulax is a monolinear Sans experimental font designed by Morgan Gilbert in 2013;
improved by Anton Moglia in 2021; and released by
[The Velvetyne Team](http://velvetyne.fr).

This font is useful for visual display as it catches eye attention on quick
glances. With the hipster art style, you can never go wrong with a mix of
artistic and professional styles.
...
```
Title: Gulax Font
Creators: Morgan Gilbert; and Anton Moglia; via The Velvetyne Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-gulax
UUID: E7FE9B01-BC28-4E04-BA2D-80EE665255A5
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-gulax
```
